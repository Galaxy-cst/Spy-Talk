<?php
     ...
     */
    class Config{
        static $appId="1456237502922222";//商户的应用ID
        static $secure_key="OrhdCp8PFsrCueLdNlbQVDHgbVnllXL1";//商户的秘钥
        static $timezone="Asia/Shanghai";//时间时区
        static $trade_time_out="3600";
        static $front_notify_url="../api/front_notify.php";
        static $back_notify_url="../api/notify.php";
